      ...
      <div className="row">
        <div className="columns large-6 small-12 medium-order-2 small-order-2 large-order-1">
          <div className="project__lending">
            ...
            <MouseScroll onClick={AnimateScroll(2000, 'project__lending')} />
          </div>
        </div>
        <div className="columns large-6 small-12 small-order-1 medium-order-1 large-order-2">
          ...
          <div className="info">
            <h1 className="h1">flowers.kzn</h1>
            <hr className="hr" />
            <h3 className="item__caption">Описание</h3>
            <p className="info__text">Проект для проведения конкурсов и голосований среди граждан на примере "цветочного фестиваля" в г.Казань.</p>
            <hr className="hr"/>
            ...
            <hr className="hr"/>
            <a target="_blank" href='https://flowers.kzn.ru/' className="btn">Перейти на сайт</a>
          </div>
        </div>
        <div className="columns large-6 small-12 medium-order-3 small-order-3">
          <div className="statistics info">
            ...
            <ul className="info__list">
              <li className="info__item">
                <span>3 года успешной работы</span>
              </li>
              <li className="info__item">
                <span>5 конкурсов</span>
              </li>
              <li className="info__item">
                <span>Тысячи участников</span>
              </li>
              <li className="info__item">
                <span>Сотни тысяч проголосовавших</span>
              </li>
              <li className="info__item">
                <span>Бессчётное число пойманных ботов</span>
              </li>
            </ul>
            <hr className="hr"/>
        ...
        <div className="columns large-6 small-12 medium-order-4 small-order-4">
          ...
          <ul className="monitor__btn-list">
            <li className="btn-list__item active" data-monitor='desktop' onClick={MonitorBtns}>
            ...
            <li className="btn-list__item rotate" data-monitor='tablet' onClick={MonitorBtns}>
            ...
            <li className="btn-list__item" data-monitor='phone' onClick={MonitorBtns}>
