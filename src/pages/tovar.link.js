      ...
      <div className="row">
        ...
        <div className="columns large-6 small-12 medium-order-4 small-order-4">
          ...
          <ul className="monitor__btn-list">
            <li className="btn-list__item active" data-monitor='desktop'>
            ...
            <li className="btn-list__item rotate" data-monitor='tablet'>
            ...
            <li className="btn-list__item" data-monitor='phone'>
